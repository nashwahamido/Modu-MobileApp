...
export function RoomExperience() {
  ...
  // The room's own backdrop axis, separate from the assembly scene's.
  ...
  // Every input path funnels through here, so the limits are enforced in one place
  ...
  return (
    <View style={s.screen}>
      {/* Sits under a transparent Filament view, framing the diorama without touching it. */}
