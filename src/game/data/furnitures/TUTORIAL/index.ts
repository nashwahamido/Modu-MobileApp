...
const model = require("../../../../assets/models/furnitures/TUTORIAL/TUTORIAL.glb");

export const TUTORIAL: Furniture = {
  meta: TUTORIAL_META,
  model,
  ...
  labels: LABELS_ALL,
  xpPerStep: 10,
  xpBonusOnComplete: 50,
};

if (typeof __DEV__ === "undefined" || __DEV__) assertValidFurniture(TUTORIAL);
