...
import { Furniture, PartDef, ThumbMap } from "@/src/game/core/type";
...
import { ACTIONS, MALM_META } from "./meta";
...
if (typeof __DEV__ === "undefined" || __DEV__) assertValidFurniture(MALM);
