// The celebration rain, shared. Lives here rather than inside BuildComplete because the catalogue
// plays the same effect on an already-assembled model — one confetti, so the two cannot drift apart
// in colour, count or pace.
