// Regenerates each furniture's joints.gen.ts — the travel vectors derived from the contact slabs at baked pose (core/derive/jointGeometry.ts). Run AFTER derive-sweep.mts, whose blocker data the sign rule consumes, and after any model re-export or JOINTS/STRUCTURE change:
...
import { deriveJointGeometry, statementsFor, type DerivationNote } from "@/src/game/core/derive/jointGeometry";
