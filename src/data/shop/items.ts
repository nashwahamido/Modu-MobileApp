...
// Not exported: SHOP_CATEGORY_TABS below is the list every caller actually wants.
...
// The orders viewCatalogue can put a catalogue in. Both surfaces ask for "name" today — the popups have no sort control — and the price orders stay because the sort is the catalogue's own vocabulary, not a widget's.
